        ...
        <div class="right">
            ...
            <table class="providerTable" cellpadding="0" cellspacing="0">
                ...
                try {
                    ...
                    PreparedStatement ps = con.prepareStatement("SELECT * FROM kll");
...
<script>
    function confirmRemove(userId) {
        ...
        var removeUser = document.getElementById("removeBi");
        confirmYes.setAttribute("href", "billdelete.jsp?no=" + userId);
